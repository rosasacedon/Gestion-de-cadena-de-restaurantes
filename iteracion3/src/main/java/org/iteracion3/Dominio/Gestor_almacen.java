...
public class Gestor_almacen extends Agente_BBDD{
	...
	public Gestor_almacen() throws Exception {
		super();
	...
	public boolean lanzar_alarma_ingredientes() throws Exception {
	...
	public boolean lanzar_alarma_bebidas() throws Exception {		
		String sql = "SELECT * FROM bebidas WHERE cantidad < 4";
		PreparedStatement ps = null;
		Agente_BBDD con = getAgente();
